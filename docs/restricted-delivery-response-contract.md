...
Обычная новая или повторная заявка сохраняет прежний контракт до отдельной версии публичного API. Минимизация применяется только после подтверждённого ограничения, hold или обезличивания.
