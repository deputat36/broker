...
description: Какие расходы могут быть при оформлении ипотеки: первоначальный взнос, оценка, страхование, госпошлины, услуги специалистов, аванс, переезд и финансовый резерв.
...
<section class="section">
  ...
  <div class="grid cards-4">
    ...
    <article class="card"><h3>Оценка объекта</h3><p>Банку может потребоваться отчет об оценке квартиры, дома или другого объекта.</p></article>
...
<section class="section content-layout">
  <article class="content-main">
    ...
    <p>Квартира, дом, участок, новостройка и вторичное жилье проверяются по-разному. Банк может запросить оценку, дополнительные документы, уточнения по правам, обременениям, состоянию объекта или характеристикам участка.</p>
