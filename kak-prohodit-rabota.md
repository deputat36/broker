...
<section class="section content-layout">
  <article class="content-main">
    ...
    <p>Конкретный объем помощи после решения банка зависит от выбранного формата работы и согласуется заранее. Для сделки через компанию «ЭТАЖИ» действует отдельный корпоративный маршрут.</p>
...
<section class="section compact-section">
  <div class="notice">
    <div>
      ...
      <p>При частном обращении объем и стоимость работы согласуются до начала платного сопровождения. Для клиентов компании «ЭТАЖИ» ипотечное сопровождение включено в комиссию компании и отдельно не оплачивается.</p>
    </div>
    <div class="hero-actions">
      <a class="btn btn-dark" href="{{ '/stoimost/' | relative_url }}">Стоимость частной работы</a>
      <a class="btn btn-dark" href="{{ '/etagi/' | relative_url }}">Клиентам «ЭТАЖИ»</a>
    </div>
  </div>
</section>
