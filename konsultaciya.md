...
<section class="section compact-section">
  <div class="notice">
    <div>
      ...
      <p>Для клиентов компании «ЭТАЖИ» услуга ипотечного брокера включена в комиссию компании, если сделка действительно проходит через «ЭТАЖИ». Частное онлайн-обращение из другого региона не относится к этому формату автоматически.</p>
    </div>
