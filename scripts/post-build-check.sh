...
required_files=(
  ...
  "$SITE_DIR/assets/css/nav-state.css"
  ...
  "$SITE_DIR/assets/js/calculator-application-prefill-runtime.js"
...
node --check "$SITE_DIR/assets/js/calculator-application-prefill-runtime.js"
node scripts/test-calculator-application-prefill.js "$SITE_DIR/assets/js/calculator-application-prefill-runtime.js"
...
python3 scripts/audit-contact-application-routes.py "$SITE_DIR"
python3 scripts/audit-premium-redesign.py "$SITE_DIR"
python3 scripts/audit-premium-homepage-polish.py "$SITE_DIR"
python3 scripts/audit-homepage-lead-routing.py "$SITE_DIR"
python3 scripts/audit-application-compact-footer.py "$SITE_DIR"
