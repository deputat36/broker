...
required_files=(
  ...
  "$SITE_DIR/assets/js/application-inputs.js"
...
node --check "$SITE_DIR/assets/js/application-inputs.js"
node scripts/test-application-consent-validation.js "$SITE_DIR/assets/js/application-inputs.js"
