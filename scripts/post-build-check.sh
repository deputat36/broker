...
required_files=(
  ...
  "$SITE_DIR/assets/js/application-consent-validation.js"
...
node --check "$SITE_DIR/assets/js/application-consent-validation.js"
node scripts/test-application-consent-validation.js "$SITE_DIR/assets/js/application-consent-validation.js"
