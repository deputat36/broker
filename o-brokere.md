...
<section class="page-hero section">
  <div class="breadcrumbs"><a href="{{ '/' | relative_url }}">Главная</a> / О брокере</div>
  <p class="eyebrow">Личный специалист по ипотеке</p>
  <h1>Татьяна Стерликова</h1>
  <p class="lead">Ипотечный брокер для покупателей жилья из Борисоглебска, Борисоглебского городского округа, Грибановского и Поворинского районов.</p>
  <div class="hero-actions"><a class="btn btn-primary" href="{{ '/online-zayavka/' | relative_url }}?source={{ page.url | url_encode }}&amp;scenario={{ 'Первичная консультация и подбор ипотеки' | url_encode }}">Заполнить онлайн-заявку</a><a class="btn btn-secondary" href="tel:+79030250807">Позвонить Татьяне</a><a class="btn btn-light" href="{{ '/konsultaciya/' | relative_url }}">Бесплатная консультация</a></div>
</section>
...
<section class="section muted">
  ...
  <div class="grid cards-4">
    ...
    <article class="card"><h3>Понятно по стоимости</h3><p>Первичная консультация бесплатная, платное сопровождение согласуется заранее.</p></article>
...
<section class="section cta-section"><div><p class="eyebrow">Связаться с Татьяной</p><h2>Начните с бесплатной первичной консультации</h2><p>Заполните короткую анкету или подготовьте город, тип объекта, примерную стоимость, доход, первоначальный взнос и сведения о предыдущих заявках.</p></div><div class="cta-actions"><a class="btn btn-primary" href="{{ '/online-zayavka/' | relative_url }}?source={{ page.url | url_encode }}&amp;scenario={{ 'Первичная консультация и подбор ипотеки' | url_encode }}">Онлайн-заявка</a><a class="btn btn-secondary" href="tel:+79030250807">8 903 025-08-07</a><button class="btn btn-secondary" type="button" data-copy-phone>MAX</button><a class="btn btn-secondary" href="https://vk.com/tatyanasterlikova" rel="noopener">ВКонтакте</a></div></section>
